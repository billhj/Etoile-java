 ...
 * @composed - - * vib.core.util.speech.Boundary
 * @composed - - * vib.core.util.speech.PitchAccent
...
//TODO add sressingpoint ? but it is only aviable with open Mary
     ...
     * @return the {@code String} of the original text orresponding to this {@code Speech}
     */
     ...
     * @return the {@code Audio} orresponding to this {@code Speech}
     ...
     * @see vib.core.util.audio.Audio#save(java.lang.String) Audio.save(String)
     */
...
//    }
    ...
    public XMLTree toSSML(double rate, double pitch) throws Exception{
        ...
        TimeMarker tmpEndPitchAccent = null;
        XMLTree tmpEndPitchAccentXMLNode = null;

        for(int i=1; i<speechElements.size()-1; ++i){ //skip start and end //am: why?
            ...
            if(o instanceof String)
            {
                if(tmpEndPitchAccentXMLNode==null)
                {
                    ...
                    tmpEndPitchAccentXMLNode.addText((String)o);
                }
            }
            else{
                if(o instanceof TimeMarker){
                    // time ?
                    if(tmpEndPitchAccent!=null && ((TimeMarker)o).equals(tmpEndPitchAccent))
                    {
                    ...
                    } else if(tmpEndPitchAccent!=null && !((TimeMarker)o).equals(tmpEndPitchAccent)) {
                    ...
                    if(o instanceof Boundary){
                        ...
                        if(o instanceof PitchAccent){
                            ...
                            tmpEndPitchAccent = pitchAccent.getEnd();
...
//Static fields :
     ...
     * @see #toXML(boolean)
     * @see #toSAPI4()
     * @see #readFromXML(vib.core.util.xml.XMLTree, boolean)
     */
